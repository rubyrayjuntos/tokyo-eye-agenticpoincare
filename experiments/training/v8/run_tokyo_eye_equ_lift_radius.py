...
from experiments.training.v8.equ_lift_radius import (
    ...
    LiftRadiusGuardError as CorrectStartGuardError,
    assert_frontend_bank,
    assert_not_forbidden_ckpt,
    assert_pure_hyp_strict,
    build_lift_radius_stamp as build_correct_start_stamp,
...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--pins", type=Path, default=Path("data/gates/tokyo_eye_equ_lift_radius_pins.json"))
...
def main() -> int:
    ...
    run_name = f"eqf_equ_lift_radius_{date.today().strftime('%Y%m%d')}"
