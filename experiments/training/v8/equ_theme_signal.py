"""tokyo_eye_equ_theme_signal — theme dehydron AUPRC + geometry HOLD helpers."""
...
GATE_ID = "tokyo_eye_equ_theme_signal"
...
from experiments.training.v8.equ_lift_radius import (  # noqa: E402
    ...
    RV_VOLUME_SIGMA,
    RV_WEIGHT_DECAY,
    LiftRadiusGuardError as ThemeSignalGuardError,
    assert_pure_hyp_strict,
    load_boot_split,
    normalized_routing_entropy,
)

DEFAULT_STAMP = Path("data/gates/tokyo_eye_equ_theme_signal.json")
DEFAULT_PINS = Path("data/gates/tokyo_eye_equ_theme_signal_pins.json")
MLFLOW_RUN_NAME = GATE_ID
CorrectStartGuardError = ThemeSignalGuardError
    ...
    stamp.update(
        {
            ...
            "artifacts": [
                ...
                "experiments/training/v8/run_tokyo_eye_equ_theme_signal.py",
            ],
        }
    )
    if extra:
...
__all__ = [
    ...
    "TB_THEME_COLLAPSE",
    "ThemeSignalGuardError",
    "CorrectStartGuardError",
    "assert_frontend_bank",
    "assert_not_forbidden_ckpt",
    "assert_pure_hyp_strict",
    "build_theme_signal_stamp",
    "enrich_rim_probe_row",
    "epoch_is_best_eligible",
    "evaluate_lift_spine_equivariance",
    "evaluate_probe_hygiene",
    "evaluate_theme_signal",
    "load_boot_split",
    "load_pins",
    "normalized_routing_entropy",
