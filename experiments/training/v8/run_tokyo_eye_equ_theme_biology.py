...
from experiments.training.v8.equ_theme_biology import (
    ...
    build_theme_biology_stamp as build_correct_start_stamp,
...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--pins", type=Path, default=Path("data/gates/tokyo_eye_equ_theme_biology_pins.json"))
...
def main() -> int:
    ...
    run_name = f"eqf_equ_theme_biology_{date.today().strftime('%Y%m%d')}"
