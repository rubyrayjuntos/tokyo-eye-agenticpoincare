    ...
    *,
    ...
    if bool(getattr(model, "role_edge_mp", False)):
        ...
        if bool(getattr(model, "chem_edge_mp", False)):
            ...
            euc_on = bool(getattr(model, "euclidean_shortcut_mp", False))
            contain_on = bool(getattr(model, "containment_edge_mp", False))
            if euc_on and contain_on:
                raise ValueError(
    ...
    *,
    ...
    epoch_losses: dict[str, list[float]] = {
        ...
        for k in [
            ...
            "routing_entropy_sparsity_loss",
            "routing_entropy_sparsity_coeff",
            "v2_teacher_total",
            "v2_teacher_depth",
            ...
            def _forward_losses() -> dict[str, Any]:
                ...
                if (
                    ...
                    if teacher_targets is not None:
                        from science.dtie.v66.loss import v2_teacher_distill_loss
