...
def load_training_proteins(
    ...
    *,
    ...
    from experiments.training.v66._data import load_protein_graph
    ...
    for entry in entries:
        ...
        if use_dehydron_barcode:
            ...
            from experiments.training.v66._data import attach_dehydron_barcode_features
        ...
        if dehydron_edge_barcode:
            ...
            from experiments.training.v66._data import attach_dehydron_edge_barcode_lookup
        ...
        if residue_stage >= 2:
            from experiments.training.v66.pipeline_labels import attach_pipeline_supervision

            attach_pipeline_supervision(prot, pdb_dir)
        elif residue_stage >= 1:
            from experiments.training.v66.residue_labels import attach_residue_supervision
