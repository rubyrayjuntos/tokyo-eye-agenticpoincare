...
def main() -> None:
    ...
    parser.add_argument(
        "--output-dir", type=Path, default=Path("checkpoints/v6/runs/default")
    )
    ...
    parser.add_argument(
        ...
        default="v6",
        help="Architecture package line (v6=frozen baseline, v6.5/v6.6=development forks)",
    )
    ...
    from experiments.training.v6.export_corpus_viewers import (
