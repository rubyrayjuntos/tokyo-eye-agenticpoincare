...
DESIGN CONTRACT:
  Inputs (unchanged from v5):
    ...
    edge_attr: [E,4]  (rel_x, rel_y, rel_z, distance)
                      or [E,9] when thermo_edge_message_gate (geo4 + thermo5)
  ...
  V6 additional inputs (attached to PyG Data):
    ...
    thermo_edge_features (optional): training-only affinity channels on edges
...
class GOSPConeMapperV66(nn.Module):
    """
    Tokyo Eyes v6 — Topologically-Routed MoE Specialization.
    ...
    def __init__(
        ...
        if self.role_edge_mp:
            ...
            from science.dtie.v66.thermo_edge_features import GEO_DIM as _GEO
        ...
        if self.geometric_angular_prior:
            from science.dtie.v66.geometric_angular_prior import DiscAngularResidual
    ...
    def forward(self, data: Data) -> dict[str, Any]:
        ...
        if (
            ...
            from science.dtie.v66.geometric_angular_prior import apply_geometric_disc_prior
...
def verify_v66_checkpoint(
    ...
    *,
    ...
    """Verify checkpoint loads into the in-repo GOSPConeMapperV66 architecture.
    ...
    model = GOSPConeMapperV66(node_dim=node_dim, **kwargs)
