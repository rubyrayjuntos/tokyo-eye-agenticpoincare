...
13. **Tokyo Eye — active trunk SSOT (2026-07-23):** Production model lives under [`science/tokyo_eye/`](science/tokyo_eye/) (contract id from catalog / `tokyo_eye_*`). Equiformer/SE(3) frontend + hyperbolic spine + MoE. Checkpoints and restore via **MLflow aliases** (see governance design); local paths are cache only. Spec hub: [`docs/specs/tokyo-eye-v8/README.md`](docs/specs/tokyo-eye-v8/README.md) until lineage-agnostic docs fully replace revision-named folders. Biology TODOs: [`biology-roadmap.md`](docs/specs/tokyo-eye-v8/biology-roadmap.md). Prior Hyp-MP line under `TokyoEye.py` / `checkpoints/v7/` is **dead archaeology**. Trunk stamp: [`data/gates/tokyo_eye_v8_trunk_ssot.json`](data/gates/tokyo_eye_v8_trunk_ssot.json). Governance: [`docs/superpowers/specs/2026-07-23-tokyoeye-mlflow-governance-design.md`](docs/superpowers/specs/2026-07-23-tokyoeye-mlflow-governance-design.md).
