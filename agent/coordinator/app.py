...
from agent.coordinator.routers import audit, chat, compare, dashboard, data, graph, hypotheses, lifecycle, orchestration, plots, poincare, rcsb, sdrp, structures, tools, therapeutic_compiler, workspace
