...
from agent.coordinator.routers import audit, chat, compare, dashboard, data, graph, hypotheses, orchestration, plots, poincare, rcsb, sdrp, structures, tools, therapeutic_compiler, workspace
