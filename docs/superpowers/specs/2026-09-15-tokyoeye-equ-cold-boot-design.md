...
**SSOT (amended freeze):** [`2026-09-15-tokyoeye-equ-pure-hyp-freeze-amendment.md`](2026-09-15-tokyoeye-equ-pure-hyp-freeze-amendment.md) · gate `data/gates/tokyo_eye_equ_pure_hyp_freeze_amendment.json`.
...
Boot recorded that live `attention.py` `_tangent_linear` **remained** → `pure_hyp_pass=false` for this run. Remediation is a **separate** pre-registered card (not silent). A rim Pass does **not** waive pure hyp.
