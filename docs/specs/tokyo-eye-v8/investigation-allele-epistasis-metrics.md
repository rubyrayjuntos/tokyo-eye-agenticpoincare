...
> **Trunk:** v8 only. Copied from closed v7 defs; Θ is `HEALTHY_V8_SPINE_CKPT`.
> Do not open v7 for new probes.


**Status:** STARTING DEFINITIONS (parked with uncertainty work, 2026-07-21)  
**Applies to:** Frozen Tokyo Eye v8 (`Θ` fixed) · output `x_hyp` · hyperbolic inference layer  
**Unpark / evidential track:** [`../tokyo-eye-v7/bprime-uncertainty-unpark.md  # archaeology`](../tokyo-eye-v7/bprime-uncertainty-unpark.md  # archaeology)  
...
Invariant \(\Theta\) (e.g. `HEALTHY_V8_SPINE_CKPT` / sealed health) is a fixed lens. Mutational / epistatic **investigation** is then:
...
|-------|--------|----------------------|-------------|
| Evidential aleatoric / epistemic | NIG head | Yes — [`../tokyo-eye-v7/bprime-uncertainty-unpark.md  # archaeology`](../tokyo-eye-v7/bprime-uncertainty-unpark.md  # archaeology) | PARKED |
