# Tokyo Eye v8 — biology roadmap (hub / teleconnection track)
...
| — | **B5** | Zero-shot ligand | Affinity seal exists; zero-shot still deferred |

**Do not** treat sealed affinity Core \(R\approx0.407\) as B1 teleconnection Pass.
...
## B1 — Teleconnections (TODO)

Re-prereg under v8 Equiformer→hyp spine. Historical v7 closeout (`tokyo_eye_v7_b1_teleconnections_closeout.json`) is archaeology only (scramble>conduit on dead stack).

---

## Forbidden claims

* v7 sealed health = v8 biology champion  
* Affinity CASF Pass = cryptic pocket / allostery Pass  
* Disc rim = pathway  
* Embedding density = free energy  
